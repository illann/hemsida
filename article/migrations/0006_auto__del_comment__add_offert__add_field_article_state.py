...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Offert'
        db.create_table(u'article_offert', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('article_owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['article.Article'])),
            ('body', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('price', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'article', ['Offert'])

        # Adding field 'Article.state'
        db.add_column(u'article_article', 'state',
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Offert'
        db.delete_table(u'article_offert')

        # Deleting field 'Article.state'
        db.delete_column(u'article_article', 'state')
    ...
    models = {
        ...
        u'article.offert': {
            'Meta': {'object_name': 'Offert'},
            'article_owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['article.Article']"}),
