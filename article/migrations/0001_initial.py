...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'article_article', (
            ...
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date.today)),
            ('del_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('kvalitetskrav', self.gf('django.db.models.fields.CharField')(max_length=100)),
